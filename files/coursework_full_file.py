...
print()
print()
print("-----------------------------------------------------Welcome to IIT Cricket Premier League 2021--------------------------------------------------------------")
...
def first_innings():
    ...
    #     # temp1 = int((bowler_overs_first_ing[1])/6)
    #     # temp2 = (bowler_overs_first_ing[1]) % 6
    #     # str('temp1') + '.' + str('temp2')
    #     bowler_overs_first_ing[1] = '4.5'
    ...
    # temp3 = int((first_ing_balls-1)/6)
    # temp4 = (first_ing_balls-1) % 6
    overs = '666666666666666'  # str(temp3) + '.' + str(temp4)
    first_ing_summary = [
...
def second_innings():
    ...
    for bowler_overs_second_ing in bowler_list_second_ing:
        ...
        # temp5 = (bowler_overs_second_ing[1])/6)
        # temp6 = (bowler_overs_second_ing[1]) % 6
        # str(temp5) + '.' + str(temp6)
        bowler_overs_first_ing[1] = '2'
    ...
    # temp7 = int((second_ing_balls-1)/6)
    # temp8 = (second_ing_balls-1) % 6
    overs = 'dgfhgdxfhgdxhdfrhg'  # str(temp7) + \
    # '.' + str(temp8)
    second_ing_summary = [
